...
@Observable
class OtherRecieptViewModel {
    var selectedSegment: ReceiptSegment = .receipt1 {
        didSet {
            startOCR(selectedSegment)
        }
    }

    var currentReceipt: OtherRecieptModel?
    ...
    private func parseWithoutRegex(from text: String) -> OtherRecieptModel {
